"""P2 Part 3 ホットフィックス v3: playwright-stealth で Cloudflare 検知を回避する。"""
...
# ---------------------------------------------------------------------------
# scrape/playwright_fallback.py  (stealth 対応)
# ---------------------------------------------------------------------------
FILES["src/juggler_predictor/scrape/playwright_fallback.py"] = '''"""Playwright + stealth で cf_clearance を取得する (手動誘導モード)。
...
def main() -> None:
    print("=" * 60)
    print("P2 Part 3 fix v3: playwright-stealth 対応")
    print("=" * 60)
    ...
    print()
    print("次のコマンド (3 ステップ):")
    print("  1) uv add playwright-stealth")
    print("  2) python setup_p2_part3_fix3.py  (このスクリプト)")
    print("  3) uv run python scripts/refresh_cf_cookie.py")
