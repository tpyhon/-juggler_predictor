"""P2 Part 1 ホットフィックス: tests/test_scrape_parser.py の canonical キー名を修正。"""
from __future__ import annotations
from pathlib import Path

ROOT = Path(__file__).resolve().parent
TARGET = ROOT / "tests" / "test_scrape_parser.py"

NEW_CONTENT = '''"""parser.py のユニットテスト。
...
def main() -> None:
    ...
    print("[OK] test_scrape_parser.py を修正しました")
    print()
    print("次のコマンド:")
